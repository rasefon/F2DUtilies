...
#ifndef F2DUTILIES_HZST_LAYER_H
#define F2DUTILIES_HZST_LAYER_H
...
class HzSemanticTypeLayer : public HzSemanticTypeBase {
private:
  HzDataTypeVarint _layer;
public:
  HzSemanticTypeLayer(uint64_t layer);
